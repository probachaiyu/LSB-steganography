...
class Ui_MainWindow(object):
    ...
    #Function to choose input directory

    def OpenDir(self):
        global input_path_dir
        input_path_dir = QtWidgets.QFileDialog.getExistingDirectory(None, 'Выберите папку')
        self.lineEdit.setText(input_path_dir)
        
    #Function to display save file dialog
    def saveFile(self):
        output_path = QtWidgets.QFileDialog.getExistingDirectory(None, 'Выберите папку для сохранения выходных изображений')
        return output_path

    #Function to encode data and save file
    def encode(self):
        list_files=os.listdir(input_path_dir)
        list_files.sort()
        len_list_infiles = len(list_files)
        text = self.plainTextEdit.toPlainText()
        div_text = list(self.chunk(text,len_list_infiles))
    ...
    def chunk(self,text, num_files):
        text_len = len(text)
        chunk_size = len(text) // text_len
        if len(text) % text_len:
            chunk_size += 1
        text_list = list(text)
        for _ in range(num_files):
            yield ''.join(text_list[_::num_files])

    def dechunk(self, text_list):
        return list(itertools.chain(*list(itertools.zip_longest(*text_list, fillvalue=''))))
    ...
    def decode(self):
        ...
        if input_path_dir == '':
            ...
            try:
                ...
                self.plainTextEdit_2.document().setPlainText(text)
                self.progressBar_2.setValue(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Шаг 1:</span></p></body></html>"))
        self.label_3.setText(_translate("MainWindow", "Дирректория входных изображений:"))
        self.pushButton.setText(_translate("MainWindow", "Выберите дирректорию"))
        self.label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; color:#5500ff;\">Шифровать</span></p></body></html>"))
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; color:#5500ff;\">Расшифровать</span></p></body></html>"))
        self.label_5.setText(_translate("MainWindow", "Введите текст, чтобы скрыть:<html><head/><body><p><span style=\" font-weight:600;\">Шаг 2:</span></p></body></html>"))
        self.label_7.setText(_translate("MainWindow", ""))
        self.label_8.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Шаг 3:</span></p></body></html>"))
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Кодировать и сохранять"))
        self.label_6.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Шаг 2:</span></p></body></html>"))
        ...
        self.label_13.setText(_translate("MainWindow", "Загрузка:"))
        self.label_12.setText(_translate("MainWindow", "Декодированные данные:"))
